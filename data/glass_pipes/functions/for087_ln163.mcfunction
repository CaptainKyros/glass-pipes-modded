...
execute as @e if score @s _id = Global _id run function glass_pipes:execute067_ln165
execute if score Global mai_scratch1 matches 1.. at @s align xyz positioned ~0.5 ~ ~0.5 run function glass_pipes:execute072_ln223
execute if score @s pipe_sound matches 1.. at @s run function glass_pipes:execute086_ln244

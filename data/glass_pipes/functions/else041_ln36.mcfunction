...
execute store result score Global fx run scoreboard players get Global pic_scratch2
execute store result score Global fy run scoreboard players get Global pic_scratch3
execute store result score Global fz run scoreboard players get Global pic_scratch4

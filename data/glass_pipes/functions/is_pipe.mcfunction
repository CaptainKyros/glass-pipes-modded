...
execute if block ~1 ~ ~ minecraft:glass if block ~-1 ~ ~ minecraft:glass run function glass_pipes:execute049_ln108
execute if score Global is__scratch0 matches 1.. run scoreboard players set Global glass_x 0
scoreboard players set Global is__scratch0 1
execute if block ~ ~1 ~ minecraft:glass if block ~ ~-1 ~ minecraft:glass run function glass_pipes:execute050_ln114
execute if score Global is__scratch0 matches 1.. run scoreboard players set Global glass_y 0
scoreboard players set Global is__scratch0 1
execute if block ~ ~ ~1 minecraft:glass if block ~ ~ ~-1 minecraft:glass run function glass_pipes:execute051_ln120
...
scoreboard players set Global is__scratch0 1
execute if score Global glass matches 2..2 if block ~ ~ ~ minecraft:air run function glass_pipes:execute052_ln128

...
execute if score @e[type=minecraft:player,limit=1,scores={mai_scratch0=1..}] pipe_slow matches 1.. run function glass-pipes-improved:execute054_ln172
execute if score Global mai_scratch3 matches 1.. run function glass-pipes-improved:else055_ln172
...
execute if score Global mx matches 0..0 run function glass-pipes-improved:execute056_ln178
execute if score Global my matches 0..0 run function glass-pipes-improved:execute057_ln181
execute if score Global mz matches 0..0 run function glass-pipes-improved:execute058_ln184
...
execute at @s run function glass-pipes-improved:execute062_ln193

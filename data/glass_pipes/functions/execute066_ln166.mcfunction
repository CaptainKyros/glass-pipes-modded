...
execute at @e[type=minecraft:area_effect_cloud,tag=Position,limit=1] if block ~ ~ ~ minecraft:air run function glass_pipes:execute063_ln171
execute if score Global mai_scratch2 matches 1.. run function glass_pipes:else065_ln171